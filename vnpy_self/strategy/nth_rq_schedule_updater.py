...
if __name__ == "__main__":
    ...
    next_trading_day_dom_list,next_trading_day_dom2_list = [],[]
    next_trading_day = get_next_trading_date(today_str)
    for i in all_futures_df['underlying_symbol'].values:
        ...
        next_trading_day_dom_list.append(next_trading_day_dom_contract)
        ...
        if i in symb_list:
            ...
            next_trading_day_dom2_list.append(can.idxmax())